...
| AegisOps Patch Review Queue ranks proposed patch reviews across scenarios. | [`aegisops-agent/reports/patch-review-queue.md`](../aegisops-agent/reports/patch-review-queue.md) | `make -C aegisops-agent patch-review-queue PYTHON=<python>` | verified by `make demo-all` and `make portfolio-check` | deterministic queueing over synthetic fixtures, not a code-review replacement |
...
| Kube Policy Pack exports the validation rules as a reusable reviewer artifact. | [`kube-copilot/reports/policy-pack.md`](../kube-copilot/reports/policy-pack.md), [`kube-copilot/reports/policy-pack.json`](../kube-copilot/reports/policy-pack.json) | `make -C kube-copilot policy-pack` | verified by `make demo-all` and `make portfolio-check` | deterministic rule export only, not policy-as-code enforcement |
...
| EvidenceOps Release Gate turns public evidence into a release/share readiness decision. | [`evidenceops-scorecard/reports/release-gate.md`](../evidenceops-scorecard/reports/release-gate.md), [`evidenceops-scorecard/reports/release-gate.json`](../evidenceops-scorecard/reports/release-gate.json) | `make -C evidenceops-scorecard release-gate` | verified by `make demo-all` and `make portfolio-check` | public release gate only, not official application approval |
