...
`container_runs_as_root` with confidence `0.97`.
...
- `/opt/anaconda3/bin/python3.13 scripts/devops_check.py --scenario S7 --patched-dir reports/S7/multi/patched`
