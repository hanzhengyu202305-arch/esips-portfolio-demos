...
`invalid_app_mode_env` with confidence `0.93`.
...
- `/opt/anaconda3/bin/python3.13 scripts/devops_check.py --scenario S4 --patched-dir reports/S4/single/patched`
